...
<div class="theme-layout">
    ...
    <figure class="card card-product-grid card-lg"> <a href="#" class="img-wrap" data-abc="true"> <img src="${product.getPhotosImagePath()}"> </a>
        <figcaption class="info-wrap">
            <div class="row">
                <div class="col-md-9 col-xs-9"> <a href="#" class="title" data-abc="true">${product.pname}</a> <span class="rated">${product.category}</span> </div>
        ...
        <div class="bottom-wrap-payment">
            <figcaption class="info-wrap">
                <div class="row">
                    <div class="col-md-9 col-xs-9"> <a href="#" class="title" data-abc="true">${product.price}</a> <span class="rated">VISA Platinum</span> </div>
                    <div class="col-md-3 col-xs-3">
        ...
        <div class="bottom-wrap"> <a href="#" class="btn btn-primary float-right" data-abc="true"> Buy now </a>
            <div class="price-wrap"> <a href="/addtocart/${id}" class="btn btn-warning float-left" data-abc="true"> Add To Cart </a> </div>
        </div>
    </figure>
</div>		
