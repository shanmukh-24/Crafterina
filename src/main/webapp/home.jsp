						...
						<div class="row" id="page-contents">
							...
							<div class="col-lg-6">
								...
								<div class="central-meta item">
									<div class="user-post" id="${post.id}">
										<div class="friend-info">
											<figure>
												<img src="images/resources/friend-avatar10.jpg" alt="">
											</figure>
											<div class="friend-name">
												<ins><a href="/shop/${ post.manager.username}" title="">${post.manager.username}</a></ins>
												<span>published: ${post.createdDate}</span>
											</div>
											<div class="post-meta">
												<img src="${post.getPhotosImagePath()}" alt="">
												<div class="we-video-info">
													<ul>
														<li>
														<a href="/likepost/${post.id}">
												...
												<button class="btn-primary"> <a href="buyproduct/${post.product.pid}">Buy Now</a></button>
														</li>
																											</ul>
												</div>
