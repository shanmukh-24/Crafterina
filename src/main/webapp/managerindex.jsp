...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href=managerindex.jsp"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
			<li><a href="charts.jsp"><em class="fa fa-bar-chart">&nbsp;</em> Charts</a></li>
			<li><a href="/allproducts"><em class="fa fa-toggle-off">&nbsp;</em> View Products</a></li>
